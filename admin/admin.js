var express = require('express'),
  ...
  payment = require('./lib/payment_client');

var app = express();
app.set('port', conf.admin_port || 3000);
...
app.set('views', conf.adminTemplatesPath);
...
var multerPath = conf.adminUploadPath;
